/**
 * MCRC Portal design tokens (shared with apps/portal — from
 * design_handoff_accounting_portal/README.md "Design Tokens"). Components reference
 * these semantic names — never raw hex.
